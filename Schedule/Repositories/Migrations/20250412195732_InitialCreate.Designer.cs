...
namespace Repositories.Migrations
{
    ...
    [Migration("20250412195732_InitialCreate")]
            ...
            modelBuilder.Entity("ReceptionWorker", b =>
                {
                    ...
                    b.Property<int>("upcomingReceptionsid")
                        .HasColumnType("integer");

                    b.HasKey("personnelid", "upcomingReceptionsid");

                    b.HasIndex("upcomingReceptionsid");
            ...
            modelBuilder.Entity("ReceptionWorker", b =>
                {
                    ...
                    b.HasOne("Models.Reception", null)
                        .WithMany()
                        .HasForeignKey("upcomingReceptionsid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
