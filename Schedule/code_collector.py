...
# Настройки
extensions = [".py"]  # Какие типы файлов включать
project_root = "D:\piaps\Schedule\tgBot"  # Корень проекта (можно заменить на путь к вашему проекту)
output_file = "combined_code_tgBot.txt"  # Имя выходного файла
